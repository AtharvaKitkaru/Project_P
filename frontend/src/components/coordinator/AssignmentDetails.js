            ...
            <form id='assignment-form' onSubmit={this.handleSubmit}>
              <div className='form-group'>
                ...
                <input
                  ...
                  value={this.ass.assignment_details.assignment.title }
                  readOnly={true}
                  required
                />
              </div>
              <div className='form-group'>
                ...
                <textarea
                  ...
                  onChange={this.handleChange}
                  value={
                    this.ass.assignment_details.assignment.description 
                  }
                  readOnly={true}
                />
              </div>
              <div className='form-group'>
                ...
                <input
                  ...
                  onChange={this.handleChange}
                  value={
                    this.ass.assignment_details.assignment.weightage 
                  }
                  readOnly={true}
                />
              </div>
                ...
                <div className='col-md-6 p-1'>
                  <div className='form-group'>
                    ...
                    <input
                      ...
                      onChange={this.handleChange}
                      value={
                        this.ass.assignment_details.assignment.date 
                      }
                      readOnly={true}
                    />
                  </div>
